document.addEventListener('DOMContentLoaded', function () {
    ...
    if (heroSection) {
        const slidesData = [
            ...
            { image: 'img/camiseta Shawn Mendes.jpg', title: 'CAMISETA SHAWN MENDES', subtitle: 'MODELO 2', description: 'Tem umas pessoas que nasceram amadas por Deus né...', avatar: 'img/ShawnMendes.jpg' },
            { image: 'img/Moletom Charlie Brown Jr.jpeg.jpg', title: 'MOLETOM CHORÃO', subtitle: 'MODELO 3', description: 'Andar de skate e tocar, é corri pra ver o mar fui atrás do que quis, é sabia, só assim, podia ser feliz eu quero ser feliz quem não quer ser feliz, me diz?', avatar: 'img/chorao.jpg' }
        ];
        let currentSlide = 0;
